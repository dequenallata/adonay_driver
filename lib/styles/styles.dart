...
Color newTextColor = const Color.fromARGB(255, 255, 255, 255);
...
Color buttonColor = Color.fromRGBO(169, 62, 102, 1);
Color newRedColor = Color.fromRGBO(169, 62, 102, 1);
Color trazoColor = Color.fromRGBO(169, 62, 102, 1);
Color theme = Color.fromRGBO(169, 62, 102, 1);
...
Color loaderColor = Color.fromRGBO(169, 62, 102, 1);
...
Color starsColor = Colors.amber;
Color verifyDeclined = Color.fromRGBO(169, 62, 102, 1);
Color offline = const Color(0xff898989);
Color online = const Color(0xff309700);
Color onlineOfflineText = const Color(0xffFFFFFF);
Color onlineDriver = Color.fromRGBO(169, 62, 102, 1);
Color borderLines = const Color(0xffE5E5E5);
Color starColor = Color.fromRGBO(169, 62, 102, 1);
