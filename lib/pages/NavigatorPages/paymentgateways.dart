...
import 'package:adonay_driver/pages/NavigatorPages/walletpage.dart';
...
class _PaymentGateWaysPageState extends State<PaymentGateWaysPage> {
  ...
  void initState() {
    ...
    dynamic paymentUrl;
    paymentUrl = '${widget.url}?amount=$addMoney&payment_for=wallet&currency=${walletBalance['currency_symbol']}&user_id=${userDetails['user_id'].toString()}';
