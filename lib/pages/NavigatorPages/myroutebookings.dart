...
class _ChooseHomeAddressState extends State<ChooseHomeAddress> {
  ...
  LatLng _centerLocation = centerPosition!;
  String homeAddressConfirmation = '';
  LatLng homeAddressLatLng = centerPosition!;
  ...
  getLocs() async {
    var val = await geoCoding(centerPosition!.latitude, centerPosition!.longitude);
    setState(() {
      homeAddressConfirmation = val;
      homeAddressLatLng = centerPosition!;
    });
    _controller?.animateCamera(CameraUpdate.newLatLngZoom(centerPosition!, 14.0));
  }
                              ...
                              onTap: () async {
                                ...
                                if (locationAllowed == true) {
                                  _controller?.animateCamera(
                                      CameraUpdate.newLatLngZoom(centerPosition!, 18.0));
                                } else {
