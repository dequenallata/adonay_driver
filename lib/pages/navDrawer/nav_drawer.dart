...
import 'package:adonay_driver/pages/NavigatorPages/outstation.dart';
import 'package:adonay_driver/pages/NavigatorPages/selectlanguage.dart';
import 'package:adonay_driver/pages/NavigatorPages/settings.dart';
import 'package:adonay_driver/pages/NavigatorPages/support.dart';
                                ...
                                child: NavMenu(
                                  onTap: () async {
                                    final Uri url = Uri.parse(
                                        'https://adonay.macrobyte.cloud/privacy');
